    ...
    <div class="p-4 space-y-5">
      ...
      <div>
        ...
        <textarea
          v-model="store.task"
          rows="4"
          class="w-full px-3 py-2.5 bg-slate-800 border border-cyan-500/20 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/60 resize-none transition-all duration-150 font-mono"
